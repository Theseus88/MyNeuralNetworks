...
namespace Theseus88 {
    ...
    public:
        ...
        NeuronOutput(const std::size_t uniqueNeuronId = NeuronBase<T>::s_nextUniqueNeuronId++);
        ...
        const std::vector<T>& propagateBackward(const T targetOutputValue) override; // Still working on code here...
