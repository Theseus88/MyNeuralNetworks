...
namespace Theseus88 {
    ...
    public:
        ...
        void propagateForward(const std::vector<float>& inputVector) override; // Still working on code here...
        void propagateForward(const std::vector<double>& inputVector) override; // Still working on code here...
        void propagateForward(const std::vector<long double>& inputVector) override; // Still working on code here...
