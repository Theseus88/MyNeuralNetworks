...
namespace Theseus88 {
    ...
    template <typename T> template <LayerType LType, typename... Args> void NeuralNetwork<T>::addNetworkLayer(Args&&... args) {
        m_isFinalized = false;
    ...
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(int& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(int&& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(size_t& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(size_t&& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Input>(size_t&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(int& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(int&& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(size_t& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(size_t&& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Input>(size_t&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(int& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(int&& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(size_t& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(size_t&& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Input>(size_t&& neuronCount, NeuronType&& neuronType);

    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(int& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(int&& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(size_t& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(size_t&& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Output>(size_t&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(int& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(int&& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(size_t& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(size_t&& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Output>(size_t&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(int& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(int&& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(size_t& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(size_t&& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Output>(size_t&& neuronCount, NeuronType&& neuronType);

    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(int& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(int&& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(size_t& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(size_t&& neuronCount);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<float>::addNetworkLayer<LayerType::Dense>(size_t&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(int& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(int&& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(size_t& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(size_t&& neuronCount);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<double>::addNetworkLayer<LayerType::Dense>(size_t&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(int& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(int&& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(int& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(int&& neuronCount, NeuronType&& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(size_t& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(size_t&& neuronCount);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(size_t& neuronCount, NeuronType& neuronType);
    template void NeuralNetwork<long double>::addNetworkLayer<LayerType::Dense>(size_t&& neuronCount, NeuronType&& neuronType);
